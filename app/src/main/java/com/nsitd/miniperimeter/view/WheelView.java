...
//    private ScrollView scrollView;
    ...
    public void loadAllView(){
        for (int i =  createViewCount; i <items.size(); i++) {
...
//        this.setOrientation(VERTICAL);
        ...
        scrollerTask = new Runnable() {
            ...
            public void run() {
                ...
                int newY = getScrollY();
                if (items.size() > 10&&createViewCount<items.size()) {
                    loadAllView();
                }
...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private void initData() {
        ...
        } else for (String item : items) views.addView(createView(item));
        refreshItemView(0);
    }
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#393939"));
            } else {
                itemView.setTextColor(Color.parseColor("#9f9f9f"));
            }
        }
    }
